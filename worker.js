...
const loadTranslationService = (from, to) => {
    let start = Date.now();
    log(`translation service ${from}${to} construction starting`);
...
onmessage = function(e) {
    console.log("msg no worker");
    if (e.data[0] === "load") {
        //loadTranslationService(e.data[1], e.data[2]);
        console.log("load no worker");
        postMessage(["load", "hello world loaded"]);
        ...
        postMessage(["translation", "hello world"]);
      }
}
